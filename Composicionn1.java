...
public class Composicionn1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nombres y Apellidos: Fernando Jose Padilla Castro");
        System.out.println("Materia: Progrmacion [7450]");
